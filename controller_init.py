...
def cntrlr_init(dt, human_car_carla, nested_car_carla, theta_set, T):
    ...
    #                                          math.radians(human_car_carla.get_rotation().yaw), 16.67,
    ...
    #                                          math.radians(nested_car_carla.get_rotation().yaw), 16.67,
    ...
    experiment_env.fences += [clane1.shifted(-0.715), clane2.shifted(0.715), fakelane.shifted(0.2)]
    theta = theta_set
    ...
    # def human_speed():
    #     return -experiment_env.cars[1].traj_h.x[0][3] ** 2
    #
    # r_r = human_speed() + experiment_env.simple_reward(experiment_env.cars[1], theta, speed=22)
